...
;
const metadata = {
    title: "English for Adab - Belajar Bahasa Inggris dengan Etika",
    description: "Pembelajaran bahasa Inggris yang menggabungkan skill bahasa dengan nilai-nilai etika dan karakter yang baik.",
    generator: "v0.app",
    icons: {
        icon: [
            {
